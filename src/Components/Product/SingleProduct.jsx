...
<<<<<<< HEAD
          ...
          <Flex key={i} w={"100%"}>
            ...
            <Box w={"40%"} mt={"5%"}>
              ...
              <Text
                ...
                fontSize={16}
              >{`₹${el.actual_price}`}</Text>
              <Box mb={5}>
                <Text fontWeight={"bold"} mt={"5%"} fontSize={20}>
                  Color
                </Text>
                <Text>Puma Black-Puma White</Text>
                <Image
                  src="https://i.ibb.co/z5F6DPR/Screenshot-20221226-191032.png"
                  w={"40%"}
                />
                <Divider />
                <hr />
                ...
                <Flex gap={2} textAlign="center">
                  <Box border={"2px solid gray"} pt={"2%"} w={"8%"} h={12}>
                    {el.sizes[0].size}
                  </Box>
                  <Box border={"2px solid gray"} pt={"2%"} w={"8%"} h={12}>
                    {el.sizes[1].size}
              ...
              <Box mt={"5%"} ml={"20%"}>
                ...
                <Button
                  ...
                  fontSize={20}
                >
                  <BiHeart size={40} /> ADD TO WISHLIST
                </Button>
              </Box>
              <Box mt={"5%"} mb={"5%"}>
                <Text
                ...
                <Box mt={"3%"}>
                  ...
                  <Flex gap={"5%"}>
                    <Input
                      ...
                      h="60PX"
                    />
                    <Button bg={"BLACK"} color="white" w={"35%"} h="60PX">
                      CHECK
                    </Button>
                  </Flex>
                </Box>
              ...
              <Box mt={"5%"}>
                ...
                <Text>
                  Comfort is the name of the game with these stylish running
                  shoes. Lightweight and well-cushioned, they're the perfect..
                </Text>
                <Button
                  mt={2}
              ...
              <Box mt={"5%"}>
                ...
                <Text mt={"2%"} fontSize={19}>
                  Free standard delivery on all orders and free return within
                  <br /> 14 days of your order delivery date. Visit our Return
                  Policy
                  <br /> for more information.
                </Text>
                <Text mt={"5%"} fontSize={19}>
                  For any queries, please contact Customer Service at 080-
                  <br />
                  35353535 or via customercareindia@puma.com.
                </Text>
              </Box>
            </Box>
          </Flex>
      ...
      <Box bg="#f3f3f3" mb={10} mt={10} p={[10, 10, 10, 10]}>
        ...
        <Text mt={2}>
          Comfort is the name of the game with these stylish running shoes.
          Lightweight and well-cushioned, they're the perfect training
          companion.
        </Text>
        <Flex w={"80%"} mt={10}>
          <Box w={"60%"}>
            ...
            <Text fontSize={18} mt={2}>
              🔹 Ideal for Road & Treadmil Running
            </Text>
          </Box>
          <Box>
            <Text fontWeight={"bold"} fontSize={22}>
