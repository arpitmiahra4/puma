...
const Sport = () => {
  ...
  useEffect(() => {
    axios(`${dataUrl}/products?category=sports`)
  ...
  return (
    <>
      <MetaData title="PUMA | Sport Collections" />
      <Box mt={2}>
        <Text fontWeight={"bold"}>Home 🔹 Sport</Text>
        <Box  mt={5}>
        ...
        <Box>
          ...
          <SimpleGrid columns={names=="women_two"?[1,1,2,2,2]:[1,2,3,4,4]} >
            {sport &&
              sport.map((el, i) => (
